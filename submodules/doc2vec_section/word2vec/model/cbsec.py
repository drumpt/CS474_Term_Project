...
class CBSEC(model.Word2VecModel):
    ...
    def build(self):
        ...
        embedded = Concatenate(axis=1)([embedded_section, embedded_sequence])
        ...
        self._model = Model(inputs=[section_input, sequence_input], outputs=softmax)
